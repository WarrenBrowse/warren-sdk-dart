...
/// The account surface: the subscription snapshot (`subscriptionProvider`) and
/// `redeemVoucher`. Both need a live client (Client tab).
...
class _AccountScreenState extends ConsumerState<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PageBody(
      title: 'Account',
      subtitle: 'Subscription status and voucher redemption.',
      children: [
        SectionCard(
          title: 'Subscription',
